...
void scanner_stl_write_face(Vector3D * nml, Vector3D (* vertsBuffer)[3]) {
	// Normal vector
	scanner_stl_write_vector(nml);
	
	// Vertices of triangle
	scanner_stl_write_vector(vertsBuffer[0]);
	scanner_stl_write_vector(vertsBuffer[1]);
	scanner_stl_write_vector(vertsBuffer[2]);
